...
const PlatinRemarksProductScreen = ({navigation, route}) => {
  ...
  const INITIAL_URL = `https://extraordinary-peerless-glory.space/`;
  const URL_IDENTIFAIRE = `KN5BchkD`;
...
export default PlatinRemarksProductScreen;
