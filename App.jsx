...
import PlatinRemarksProductScreen from './src/screens/PlatinRemarksProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://exceptional-esteemed-festivity.space/`;
  const URL_IDENTIFAIRE = `ctdMKVN4`;
  ...
  OneSignal.initialize('292cca74-f1ec-4cb9-90a7-c1208f131c82');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-03-24T16:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="PlatinRemarksProductScreen"
                                    component={PlatinRemarksProductScreen}
